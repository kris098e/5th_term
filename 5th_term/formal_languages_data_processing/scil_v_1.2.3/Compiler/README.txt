...
The compiler is written in python3, developed using Python 3.6.7, but
latest checked with Python 3.10.6, the ply package version 3.11 and
the singleton-decorator package version 1.0.0. The packages can be
installed via pip3.
