# VERY IMPORTANT:
- In the residual network, after an iteration, the bottleneck ark will be filled to its capacity with flow, and in the next calculated residual network, this ark will only point backwards. 
...
4. make the residual network and find the $\delta$
	1. Important that you look at how we calculated this. There is a picture somewhat above this showing calculation of $C_{f}$
