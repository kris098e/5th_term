...
we have 10 possibilities at first to choose from, then 9, then 8, then 7. meaning we ultimately have
a. $2^{10}$
b. $3^{10}$
...
a. We use $$\ceil \frac{n}{r}\geq3=\ceil \frac{n}{2}\geq3$$
...
a.
the formula $$\ceil \frac{n}{r}=\ceil \frac{9}{2}$$
