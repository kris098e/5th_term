...
and
$$E(X^2)=10*\left( \frac{1}{6} \right)^2$$
conclusion
$$Var(X)=\left( 10*\left( \frac{1}{6} \right)^2 \right)-\left( \frac{10}{6} \right)^2$$
**But this is wrong, ask mads why it is wrong?**
...
$p(Regn|forudser)=\frac{p(forudser|regn)p(regn)}{p(forudser|regn)p(regn)+ p(forudset|!regn)p(regn)}=\frac{\frac{0.9*5}{365}}{\frac{0.9*5}{365}+\frac{0.1*360}{365}}$
